...
app/src/main/kotlin/app/pbbls/android/
  PebblesApp.kt          Application entry — Hilt root, Coil image loader, no launch work
  ...
  core/designsystem/     PebblesTheme, ColorSchemes, Typography, Shapes, Spacing,
                          ...
                          SurfaceTile, PebblesLogo — thin defaults over stock M3 (#854)
...
- **The week-roll cairn is a static drawable** (`res/drawable/cairn_static.xml`)
  ...
  in Compose, since Android has no Rive runtime (see **No Rive on Android**).
