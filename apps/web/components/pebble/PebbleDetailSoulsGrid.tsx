        ...
        return (
          <li key={soul.id}>
            <button
              ...
              className="flex w-full items-center gap-3 rounded-2xl border border-border/60 bg-card px-3 py-2.5 text-left transition-colors hover:bg-muted/60 active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
