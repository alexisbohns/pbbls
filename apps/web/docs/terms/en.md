...
**Language Note:** The legally binding version of these terms is the French "Conditions Générales d'Utilisation" (CGU). This English version is a courtesy translation provided for convenience. In the event of any discrepancy between the English and French versions, the French version prevails.

---

## Preamble

These Terms of Service (the "Terms") govern your access to and use of Pebbles, a platform for collecting and revisiting personal memories.
...
These Terms apply to all versions and all devices. Your use of Pebbles constitutes acceptance of these Terms in their entirety.
...
- **Pebble**: A memory, event, or moment recorded by a Collector, enriched with emotional data, reflections inspired by cognitive behavioral therapy (CBT) techniques, and connections to Souls.

- **Soul**: A person linked to a Collector's Pebbles, representing someone in the Collector's life (friend, family, colleague, etc.).

- **Collector**: A Pebbles user who records and revisits memories.

- **Emotion Pearl**: A nuanced emotional shape attached to a Pebble, enabling deeper exploration of emotional states.
...
- **Domain**: A life domain inspired by the revisited Maslow pyramid, used to categorize Pebbles (health, relationships, creativity, learning, etc.).

- **User Account**: Your personal and secure access to the platform.

- **User Content**: All data created or uploaded by the Collector, including Pebbles, Souls, Collections, notes, and preferences.
...
By creating an account or using Pebbles, you accept these Terms in their entirety. If you do not accept these conditions, please do not use the platform.

### 2.2 Updates to Terms

Pebbles reserves the right to modify these Terms at any time. Material modifications will be communicated via in-app notification and email. Your continued use of Pebbles after a modification constitutes acceptance of the updated Terms.

### 2.3 Privacy Policy

These Terms are complemented by the [Privacy Policy](./privacy-policy.md), a separate companion document governing the processing of personal data (French version: [Politique de Confidentialité](../fr/politique-de-confidentialite.md)).
...
- Notifying Pebbles immediately if you become aware of unauthorized access

Pebbles will not be responsible for disclosure of your credentials due to your negligence or voluntary disclosure.

### 3.3 One Account Per Person

You agree to create only one account for your personal use. Creating multiple accounts by a single person is prohibited.

### 3.4 Accuracy of Information

You are responsible for ensuring that the information you provide during registration is accurate and for updating it if it changes.
...
Pebbles offers the following features:

- **Pebble Recording**: Capture memories with context, emotions, and reflections
- **Emotion Pearls**: Explore nuanced emotions attached to each memory
- **CBT-Inspired Reflections**: Structured questions to deepen understanding of events
...
- **Private**: Visible only to selected contacts
...
You agree not to use Pebbles to:
- Publish, share, or store illegal, obscene, defamatory, or hateful content
- Impersonate another person
- Harass, threaten, or intimidate other users
- Publish content that violates others' intellectual property rights or personal data
- Use the platform for stalking, surveillance, or abusive control of another person
- Promote self-harm, suicide, or other acts harmful to life or health

### 5.2 Automated Access Prohibited

You are not permitted to:
- Scrape, crawl, or automatically extract data from Pebbles
- Create bots or automated tools to access the platform without authorization
...
You retain **full ownership** of all User Content you create. Pebbles makes no claim to ownership of your Pebbles, Collections, Souls, or other personal data.
...
When you share a Pebble with other users (via public or private settings), recipients receive a non-transferable, non-exclusive viewing license. Recipients may not republish, redistribute, or commercialize your content without your express consent. You may revoke access to shared content at any time.

### 6.4 Open-Source Components

Pebbles uses open-source components and libraries governed by their respective licenses (OFL 1.1 for Ysabeau, etc.). A complete list of open-source dependencies is available in the GitHub repository. By using Pebbles, you accept the terms of these licenses.
...
- Take corrective measures necessary to maintain a respectful community
...
- Temporarily or permanently suspend or interrupt the service
...
For questions, contact: **hello@bohns.design**
