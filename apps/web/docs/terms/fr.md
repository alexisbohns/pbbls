...
Les présentes Conditions Générales d'Utilisation (« CGU ») régissent l'accès et l'utilisation de l'application Pebbles, une plateforme de collecte et revisitation de souvenirs personnels.
...
- Localisation des serveurs : Paris, France

**Plateformes couverts :**
- Web (application progressive)
- iOS (en phase de développement)
- Android (en phase de développement)

Les CGU s'appliquent à toutes les versions et tous les appareils. L'utilisation de Pebbles implique l'acceptation intégrale de ces conditions.
...
- **Pebble** : Un souvenir, un événement ou un moment enregistré par un Collecteur, enrichi avec des données émotionnelles, des réflexions inspirées des techniques de thérapie cognitive et comportementale, et des liens vers des Âmes.

- **Âme** : Une personne liée aux Pebbles d'un Collecteur, représentant quelqu'un dans la vie du Collecteur (ami, famille, collègue, etc.).

- **Collecteur** : Un utilisateur de Pebbles qui enregistre et revisualise des souvenirs.

- **Emotion Pearl** : Une forme émotionnelle nuancée attachée à un Pebble, permettant une exploration approfondie des états émotionnels.
...
- **Domain** : Un domaine de vie inspiré de la pyramide de Maslow revisitée, utilisé pour catégoriser les Pebbles (santé, relations, créativité, apprentissage, etc.).

- **Compte utilisateur** : L'accès personnel et sécurisé de l'utilisateur à la plateforme.

- **Contenu utilisateur** : Toutes les données créées ou téléchargées par le Collecteur, notamment les Pebbles, les Âmes, les Collections, les notes et les préférences.
...
En créant un compte ou en utilisant Pebbles, vous acceptez intégralement les présentes CGU. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser la plateforme.

### 2.2 Mises à jour

Pebbles se réserve le droit de modifier les CGU à tout moment. Les modifications matérielles seront communiquées par notification in-app et par email. Votre utilisation continue de Pebbles après une modification constitue une acceptation des nouvelles conditions.

### 2.3 Politique de confidentialité

Les CGU sont complétées par la [Politique de Confidentialité](./politique-de-confidentialite.md), document compagnon séparé régissant le traitement des données personnelles (version anglaise : [Privacy Policy](../en/privacy-policy.md)).
...
- La confidentialité de vos identifiants d'accès
- De toute activité survenant sous votre compte
- De notifier Pebbles immédiatement en cas d'accès non autorisé

Pebbles ne sera pas responsable de la divulgation de vos identifiants due à votre négligence ou à votre propre divulgation.

### 3.3 Un compte par personne

Vous garantissez que vous n'allez créer qu'un seul compte pour votre usage personnel. La création de multiples comptes par une seule personne est interdite.

### 3.4 Exactitude des informations

Vous êtes responsable de la précision des informations que vous fournirez lors de l'inscription et de leur mise à jour en cas de modification.
...
Pebbles offre les fonctionnalités suivantes :

- **Enregistrement de Pebbles** : Capturer des souvenirs avec contexte, émotions et réflexions
- **Emotion Pearls** : Explorer des nuances émotionnelles attachées à chaque souvenir
- **Réflexions inspirées de la TCC** : Poser des questions structurées pour approfondir la compréhension des événements
...
- **Privé** : visible uniquement pour les contacts sélectionnés
...
## 5. Obligations de l'utilisateur et utilisation acceptable

### 5.1 Contenu interdit

Vous vous engagez à ne pas utiliser Pebbles pour :
- Publier, partager ou stocker du contenu illégal, obscène, diffamatoire ou haineux
- Usurper l'identité d'une autre personne
- Harceler, menacer ou intimider d'autres utilisateurs
- Publier du contenu violant les droits de propriété intellectuelle ou les données personnelles d'autrui
- Utiliser la plateforme pour stalking, surveillance ou contrôle abusif d'une autre personne
- Promouvoir l'automutilation, le suicide ou d'autres actes nuisant à la vie ou la santé

### 5.2 Accès automatisé interdit

Vous n'êtes pas autorisé à :
- Scraper, crawler ou extraire automatiquement les données de Pebbles
- Créer des robots ou des outils automatisés pour accéder à la plateforme sans consentement
- Contourner les mesures de sécurité ou les contrôles d'accès

### 5.3 Responsabilité du contenu utilisateur
...
## 6. Propriété du contenu et droits de propriété intellectuelle

### 6.1 Propriété du contenu utilisateur

Vous conservez la **propriété complète** de tout Contenu utilisateur que vous créez. Pebbles ne revendique aucune propriété sur vos Pebbles, Collections, Âmes ou autres données personnelles.
...
Lorsque vous partagez un Pebble avec d'autres utilisateurs (via des paramètres publics ou privés), les destinataires reçoivent une licence de visualisation non transférable et non exclusive. Les destinataires ne peuvent pas republier, redistribuer ou commercialiser votre contenu sans votre consentement exprès. Vous pouvez révoquer l'accès au contenu partagé à tout moment.

### 6.4 Composants open-source

Pebbles utilise des composants et des bibliothèques open-source gouvernés par leurs licences respectives (OFL 1.1 pour Ysabeau, etc.). Une liste complète des dépendances open-source est disponible dans le dépôt GitHub. En utilisant Pebbles, vous acceptez les termes de ces licences.
...
- Suspendre ou résilier les comptes d'utilisateurs récidivistes
- Prendre des mesures correctives nécessaires pour maintenir une communauté respectueuse
...
- Suspendre ou interrompre le service temporairement ou définitivement
...
- Votre compte est impliqué dans des activités illégales ou nuisibles
...
Pour toute question, contactez : **hello@bohns.design**