...
lib/
  ...
  data/           → DataProvider interface, LocalProvider implementation, data hooks (usePebbles, useSouls, useCollections, useMarks, useKarma, useBounce, etc.)
...
- Do not import from `lib/data/local-provider.ts` directly in components — use data hooks.
