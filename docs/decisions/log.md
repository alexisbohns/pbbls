...
- **Refs:** #654, `docs/superpowers/specs/2026-07-29-public-profiles-design.md` (D4), `packages/supabase/supabase/migrations/20260730000000_public_profiles.sql`, roadmap §M50 + §5 item 8.
...
- **Supersedes / Superseded-by:** —
- **Refs:** #654, `docs/superpowers/specs/2026-07-29-public-profiles-design.md` (D1–D3, D8), `packages/supabase/supabase/migrations/20260730000000_public_profiles.sql`, `packages/supabase/scripts/verify-account-purge.ts`.
